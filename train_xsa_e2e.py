...
def main():
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        Trans.append(loss_trans.item())
        XV.append(loss_xv.item())
        Curr_LR.append(get_lr(optimizer))
        Curr_Acc.append(100 * acc)
        EER.append(100 * eer / args.lang)
        pd.DataFrame(data={"Epoch": Epoch,"LOSS":Loss,"Trans": Trans,"XV": XV,"Curr_LR":Curr_LR,"Curr_Acc": Curr_Acc,"EER":EER}).to_csv(args.savedir+"/Train.csv")
        ########  
